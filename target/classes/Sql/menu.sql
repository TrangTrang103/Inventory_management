...
(1,'/goods-issue/list','Danh sách category',1),
(1,'/goods-issue/edit','Sửa',-1),
(1,'/goods-issue/view','Xem',-1),
(1,'/goods-issue/add','Thêm mới',-1),
(1,'/goods-issue/save','Lưu',-1),
(1,'/goods-issue/delete','Xoá',-1),

(1,'/role/edit','Sửa',-1),
(1,'/role/view','Xem',-1),
(1,'/role/add','Thêm mới',-1),
(1,'/role/save','Lưu',-1),
(1,'/role/delete','Xoá',-1),